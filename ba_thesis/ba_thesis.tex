...
% 2 %
%%%%%
\chapter{Populism as an ideology of the democracy}
...
\end{quote}
Finally, this morphology of ideologies, described as conjunctions of concepts next to each other, also implies a certain indeterminacy in terms of linguistic precision and enables various narratives within the political struggle of consent and support. \cite[p.~155]{lembcke:2014}
...
ideology: ``it constitutes a significant sampling from the rich, but unmanageable and partly incompatible, variety of human thinking on politics, contained within and presented through a communicable and action-inspiring pattern'' \cite[p.~54]{freeden:1998}
